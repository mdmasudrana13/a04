...
const allBtn = document.getElementById("all-btn-id");
const interviewBtn = document.getElementById("Interview-btn-id");
const rejectedBtn = document.getElementById("Rejected-btn-id");
